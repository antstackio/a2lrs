...
import BedrockImage from "../../assets/bedrock.png";
      ...
      >
        ...
        <Link to="/bedrock">
          <Card
            ...
            cover={<img style={{ background: "#0ca37f" }} src={BedrockImage} />}
          >
            <Meta
              title="Bedrock Use Case"
              description="Bedrock on custom lambda python runtime vs OpenAI on nodejs runtime"
            />
          </Card>
        </Link>
      </div>
